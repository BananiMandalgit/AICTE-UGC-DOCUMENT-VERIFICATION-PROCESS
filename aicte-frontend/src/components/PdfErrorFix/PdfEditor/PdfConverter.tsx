    ...
    <div className="w-full max-w-md">
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="flex flex-col space-y-2">
          ...
          <div className="relative">
            <input
              ...
              name="pdfUrl"
              id="pdfUrl"
              className="block w-full rounded-md border-gray-300 shadow-sm focus:border-[#0b6e4f] focus:ring-[#0b6e4f] pl-10 pr-3 py-2"
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#0b6e4f] hover:bg-[#095a40] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0b6e4f] disabled:opacity-50"
        >
          {loading ? (
            'Converting...'
          ) : (
