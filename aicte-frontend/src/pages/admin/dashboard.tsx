          ...
          <Sidebar className="w-64 bg-white">
            <SidebarHeader>
              <div className="p-4 flex items-center space-x-2">
                <School className="h-8 w-8 text-[#0b6e4f]" />
              ...
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton 
                    ...
                    className={`${activeView === 'evaluators' ? 'bg-green-100 text-green-800' : 'text-gray-600 hover:bg-gray-100'} transition-colors duration-200`}
                  >
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton 
                    ...
                    className={`${activeView === 'institutes' ? 'bg-green-100 text-green-800' : 'text-gray-600 hover:bg-gray-100'} transition-colors duration-200`}
                  >
