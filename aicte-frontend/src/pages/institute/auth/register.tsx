...
export default function InstituteRegistrationForm() {
  ...
  const onUniversityDetailsSubmit = async (
    ...
    navigate("/institute/auth/otp", { state: finalFormData });
  };
        ...
        <div className="w-80 bg-white border-r border-gray-200 p-6 fixed h-full">
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              <img src="/approval-enginex-logo.png" alt="Approval Enginex Logo" className="h-10 w-10" />
                  ...
                  <Form {...basicDetailsForm}>
                    <form onSubmit={basicDetailsForm.handleSubmit(onBasicDetailsSubmit)} className="space-y-6">
                      ...
                      <div className="pt-6">
                        <Button
                          type="submit"
                          className="w-full bg-[#0b6e4f] hover:bg-[#095a40] text-white py-2 px-4 rounded-lg flex items-center justify-center group"
                        >
